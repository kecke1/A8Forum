...
public class GauntletRunViewModel
{
    ...
    public VehicleViewModel? Vehicle1 { get; set; } = new VehicleViewModel();

    [Display(Name = "Vehicle 2")]
    public VehicleViewModel? Vehicle2 { get; set; } = new VehicleViewModel();

    [Display(Name = "Vehicle 3")]
    public VehicleViewModel? Vehicle3 { get; set; } = new VehicleViewModel();

    [Display(Name = "Vehicle 4")]
    public VehicleViewModel? Vehicle4 { get; set; } = new VehicleViewModel();

    [Display(Name = "Vehicle 5")]
    public VehicleViewModel? Vehicle5 { get; set; } = new VehicleViewModel();
