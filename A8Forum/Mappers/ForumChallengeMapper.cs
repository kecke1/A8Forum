...
{
    public static ForumChallengeDTO ToDto(this ForumChallengeViewModel r)
    {
    ...
    public static ForumChallengeViewModel ToForumChallengeViewModel(this ForumChallengeDTO model)
    {
        return new ForumChallengeViewModel
        {
